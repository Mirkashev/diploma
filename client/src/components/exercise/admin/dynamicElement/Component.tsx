...
export default function DynamicElement({remove, instrumentId, xP, yP, width, height, dElements, keyP, imgUrl}:any){
  ...
  return(
    <Draggable
      ...
      <Resizable height={sizes.height} width={sizes.width} onResize={onResize} minConstraints={[75, 75]} maxConstraints={[150, 150]}>
